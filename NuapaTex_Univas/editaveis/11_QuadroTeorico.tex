...
autores da pesquisa.}. 
	...
	\par A especificação JPA foi construída sendo a terceira parte da
...
De acordo com \citeonline{hibernate2015} "\textit{Hibernate} cuida do
mapeamento de classes \textit{Java} para tabelas de banco de dados, e de tipos
de dados \textit{Java} para tipos de dados SQL". Este fato influi 
