...
assícrona pela \textit{Internet}". Segundo \citeonline[p.27]{sampaio2006} "O
...
a serem seguidos.
	...
	\citeonline[p.19]{guedes2011}:
		...
		\end{citacao}
			...
			\par Segundo \citeonline[p.13]{booch2006uml} "A UML é apenas uma linguagem e, 
		 portanto, é somente uma parte de um método para desenvolvimento de
		 \textit{software}". Ainda de acordo com \citeonline[p.13]{booch2006uml} "A
