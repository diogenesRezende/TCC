...
sistema web para consultar suas notas.
	...
	\par Outro instrumento utilizado para realizar esta pesquisa foram as reuniões, ou seja,
reunir-se com uma ou mais pessoas em um local, físico ou remotamente para tratar
...
plataforma \textit{Java} de desenvolvimento.
	...
	está representada na Figura \ref{fig:classecurso}.%mudar para figura
