%\section{\textit{Apache Tomcat}}
	...
	\par De acordo com \citeonline{tomcat2015}, Apache Tomcat é uma implementação
...
requisições e respostas. \citeonline{caelum2} afirma que ele é utilizado para
aplicações que necessitam apenas da parte \textit{web} do Java EE\footnote{EE -
Sigla para enterprise edition}.

	\par Segundo \citeonline{tomcat2015}, o projeto desse software começou com a
