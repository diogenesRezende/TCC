...
de informática.
	...
	\par \citeonline[s.p]{postgresWiki2015} define que “o Postgresql é um
...
robusto e confiável, além de ser extremamente flexível e rico em recursos.”
	...
	\par Conforme afirma \citeonline{milani2008}, o PostgreSql é um SGDB de código
...
cada campo a um \textit{gigabyte} de informação.
	...
	\par Segundo \citeonline{milani2008}, são características do PostgreSql:
