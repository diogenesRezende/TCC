...
\begin{itemize}
	...
	quando aplicação Android se conecta a ele. Este deve ser enviado também à
	aplicação servidora.
	...
	para que a API da \textit{Google} possa enviar as mensagens para o dispositivo
	correto.
...
servidor GCM que será encarregado de enviar a mensagem para a aplicação
\textit{mobile}.
