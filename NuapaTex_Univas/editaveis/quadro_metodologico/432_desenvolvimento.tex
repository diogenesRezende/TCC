...
classe \texttt{JpaUtil} que está representada na Figura \ref{fig:desws17}.
...
campos \textbf{Group id:} e \textbf{Artifact id:}, \textbf{Version:} e
\textbf{Packaging}. O campo \textbf{Group id:} representa id do grupo(ou
empresa) a qual pertence o projeto. Este recebeue \textbf{Artifact id:},
\textbf{Version:} e
\textbf{Packaging} 
\ref{fig:desws19}
