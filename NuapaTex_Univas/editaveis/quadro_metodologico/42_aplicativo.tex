...
executado o método \texttt{selectItem()} apresentado na \ref{fig:app4}, o qual
é responsável por retornar a posição do \textit{array} em que se encontra a
...
fim, é composto um objeto do tipo \textit{EventTO} e inserido na lista. Na
...
SQL, já que no \texttt{getFouls()}  foram buscados os dados onde o
...
dados no formato da classe \textit{EventTO}.
...
\textit{BaseExpandableListAdapter}.
